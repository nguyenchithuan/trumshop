...
export const copy = {
  vi: {
    ...
    saleLabel: "AI · SÁNG TẠO · TIỆN ÍCH SỐ",
    heroTitle: "Công cụ số cho mọi nhu cầu",
    ...
    choices: "LỰA CHỌN",
    productsLabel: "Danh mục sản phẩm",
    productsKicker: "Chọn công cụ phù hợp",
    productsTitle: "Khám phá sản phẩm số",
    productsNote: "ChatGPT, Gemini, Kling AI, OpenArt, CapCut Pro và nhiều tiện ích khác đều có tại danh mục riêng.",
    ...
    buyNow: "Mua gói này",
    comparisonLabel: "Nổi bật",
    comparisonKicker: "Dễ tìm, dễ chọn",
    comparisonTitle: "Tìm đúng công cụ trong vài giây.",
    comparisonNote: "Dùng tìm kiếm và bộ lọc để khám phá danh mục phù hợp.",
    criteria: "Tiêu chí",
    recommended: "Đề xuất",
    comparisonRows: [
    ...
    processTitle: "Chọn sản phẩm. Liên hệ. Bắt đầu.",
    processNote: "Website không yêu cầu mật khẩu hay thanh toán trực tuyến.",
    start: "Bắt đầu chọn gói",
    steps: [
      ["01", "Chọn sản phẩm", "Tìm AI, công cụ sáng tạo hoặc tiện ích phù hợp."],
    ...
    contactLabel: "Mua sản phẩm số tại TrumShop",
    contactTitle: "Sẵn sàng bắt đầu? Liên hệ ngay.",
    contactText: "Gửi nhu cầu để nhận tư vấn sản phẩm, bảo hành và báo giá phù hợp.",
    support: "Hỗ trợ",
    ...
    supportLinks: "Hỗ trợ",
    legal: "Pháp lý",
    servicePlans: "Danh mục sản phẩm",
    comparePlans: "Sản phẩm nổi bật",
    ...
    footerTagline: "Công cụ AI · Sáng tạo · Tiện ích số · Tư vấn trực tiếp.",
    disclaimer: "TrumShop là đơn vị tư vấn và hỗ trợ đăng ký độc lập. Các tên sản phẩm và nhãn hiệu thuộc về chủ sở hữu tương ứng.",
  ...
  en: {
    ...
    saleLabel: "AI · CREATIVE · DIGITAL TOOLS",
    heroTitle: "Digital tools for every need",
    ...
    productsKicker: "Choose the right tool",
    productsTitle: "Explore digital products",
    productsNote: "ChatGPT, Gemini, Kling AI, OpenArt, CapCut Pro and more tools are available in the separate catalog.",
    ...
    comparisonLabel: "Featured",
    comparisonKicker: "Easy to find, easy to choose",
    comparisonTitle: "Find the right tool in seconds.",
    comparisonNote: "Use search and filters to explore the right catalog.",
    criteria: "Criteria",
    ...
    processTitle: "Pick a product. Contact. Start.",
    processNote: "This website never asks for your password or online payment.",
    start: "Choose a plan",
    steps: [
      ["01", "Pick a product", "Find the right AI, creative or digital tool."],
    ...
    contactLabel: "Buy digital products from TrumShop",
    contactTitle: "Ready to start? Contact us.",
    contactText: "Send your needs to get product guidance, warranty options and a suitable quote.",
    support: "Support",
    updating: "Updating",
    ...
    legal: "Legal",
    servicePlans: "Product catalog",
    comparePlans: "Featured products",
    ...
    footerTagline: "AI tools · Creative tools · Digital utilities · Direct guidance.",
    disclaimer: "TrumShop is an independent registration support and consulting service. Product names and trademarks belong to their respective owners.",
    backTop: "Back to top",
    advice: "Get advice",
  ...
  return (
    <main>
      ...
      <SiteHeader
        ...
        onThemeToggle={(origin) => changeTheme(theme === "dark" ? "light" : "dark", setTheme, origin)}
      />
